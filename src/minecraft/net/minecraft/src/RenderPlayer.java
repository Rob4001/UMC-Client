...
public class RenderPlayer extends RenderLiving
{
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            {
            	//UMC ModPack Start
                if (par1EntityPlayer.username.equals("gravypod"))
                {
                ...
                if (par1EntityPlayer.username.equals("Rob4001"))
                {
                    ItemArmor itemarmor = (ItemArmor)item;
                    loadTexture((new StringBuilder()).append("/armor/").append("power.png").toString());
                    ModelBiped modelbiped = par2 != 2 ? modelArmorChestplate : modelArmor;
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
      ...
      //UMC ModPack Start
        if (par1EntityPlayer.username.equals("gravypod")&& loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                float f2 = (par1EntityPlayer.prevRotationYaw + (par1EntityPlayer.rotationYaw - par1EntityPlayer.prevRotationYaw) * par2) - (par1EntityPlayer.prevRenderYawOffset + (par1EntityPlayer.renderYawOffset - par1EntityPlayer.prevRenderYawOffset) * par2);
                float f3 = par1EntityPlayer.prevRotationPitch + (par1EntityPlayer.rotationPitch - par1EntityPlayer.prevRotationPitch) * par2;
                GL11.glPushMatrix();
        ...
        if (loadDownloadableImageTexture((new StringBuilder()).append("http://rob4001.co.uk/capes/").append(par1EntityPlayer.username).append(".png").toString(), null)) //UMC
        {
            GL11.glPushMatrix();
